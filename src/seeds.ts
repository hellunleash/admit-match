...
export const HARDWARE_SEEDS: Seed[] = [
  ...
  },
  {
    ...
    statuteChecked: "found",
    notes:
      "TECHNISCHE PHYSIK EXPLICITLY NAMED among accepted degrees, alongside EE/IT, electronics, mechanical engineering, mechatronics and materials science — and it asks for 'a high proportion of electrical engineering/electronics, SEMICONDUCTOR TECHNOLOGY and SOLID-STATE PHYSICS', which describes this transcript rather than merely tolerating it. Requires >=180 credit points / >=6 semesters. Knowledge areas: materials engineering, higher mathematics, experimental/theoretical/solid-state physics, basics of electrical engineering. *** DEPRIORITISED — KEPT ON THE LIST SO THE REASON ISN'T FORGOTTEN. *** Points-based, 60 of 90 required, and the grade band is fatal for this applicant. Rubric (Annex, Sections 4-7): (A) degree max 40 — 40 for EE/IT or engineering with micro-/nanotech specialisation, 30 for engineering with a considerable focus on electrical engineering, semiconductor physics or microelectronics, 20 for other engineering/science; (B) final grade max 30 — 1.0-1.5=30, 1.6-2.0=20, 2.1-2.5=10, AND THERE IS NO BAND BELOW 2.5, so a German 2.8 scores ZERO in a category worth a third of the total; (C) course-related achievements max 20, five points each for a 'good'/'very good' grade in principles of electrical engineering, in experimental/theoretical/solid-state physics, in materials engineering, plus five for a bachelor thesis (~10 CP) graded good/very good or one year of closely related professional experience. Realistic score here: 30 (A) + 0 (B) + ~10 (C) = ~40 against a 60 threshold. Even the best case — top degree band plus every achievement point — lands exactly on 60. Not recoverable while the grade stands. English B2, no German stated. DIRECT APPLICATION (not uni-assist) — cheaper and faster. Deadlines 15 May / 15 Sep for winter. Ecosystem: X-FAB Erfurt, CiS Mikrosensorik Erfurt, and the Jena optics cluster (Zeiss, Jenoptik, Fraunhofer IOF) within ~80 km.",
  },
  {
  ...
  },
  {
    ...
    admissionChecked: "opened",
    statuteUrl:
      "https://www.jsl.uni-freiburg.de/informationen_fuer_studierende_web/zulassungsordnungen/zulassungsordnung_m_sc__microsystems_engineering_19_01_2009.pdf",
    statuteChecked: "found",
    notes:
      "ADMISSION RESTRICTED (zulassungsbeschraenkt) — the only programme in the corridor that is, which makes the grade potentially decisive here. Zulassungsordnung dated 19.01.2009 (old but the version the university links as current); Pruefungsordnung 30.09.2021. Fully English-taught, 4 semesters, Department of Microsystems Engineering (IMTEK). Accepts 'a degree in Natural or Engineering Science, such as Electrical and Electronic Engineering, Mechanical Engineering, Mechatronics or PHYSICS'. NO German required. WARNING: English C1 required AND 'a confirmation that the medium of instruction at your university was English is NOT sufficient' — unlike TUD SEP, the medium-of-instruction route is explicitly closed, so an IELTS/TOEFL score is mandatory here. Non-EU application window 1 March - 31 May. Ecosystem: Fraunhofer IAF, ISE and IPM in Freiburg — strong for microsystems, photovoltaics and compound semiconductors.",
  },
  {
